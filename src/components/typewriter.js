...
export default function TypeWriter() {
    ...
    return (
        <React.Fragment>
            <h1>
                <a href="" className="typewrite" data-period="2000" data-type='[ "Hello, I am Jess.", "I studied graphic design in college...", "After that, i decided to focus on learning code!" ]'>
